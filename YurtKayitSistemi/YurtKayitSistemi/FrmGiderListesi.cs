...
namespace YurtKayitSistemi
{
    public partial class FrmGiderListesi : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'yurtKayıtOtomasyonDataSet5.Giderler' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.giderlerTableAdapter.Fill(this.yurtKayıtOtomasyonDataSet5.Giderler);
